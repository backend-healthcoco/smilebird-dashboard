...
public class Essentials extends GenericCollection{

	private String id;
	
	private List<CuratedMultilingual> essentialMultilingual;
...
private LevelEnum level;
	...
	public List<CuratedMultilingual> getEssentialMultilingual() {
		return essentialMultilingual;
	}

	public void setEssentialMultilingual(List<CuratedMultilingual> essentialMultilingual) {
		this.essentialMultilingual = essentialMultilingual;
	}
	...
	public String toString() {
		return "Essentials [id=" + id + ", essentialMultilingual=" + essentialMultilingual + ", discarded=" + discarded
				+ "]";
	}
