...
public class IndirectLarygoscopyExamination extends GenericCollection {
	...
	public String toString() {
		return "IndirectLarygoscopyExamination [id=" + id + ", indirectLarygoscopyExam=" + indirectLarygoscopyExam
