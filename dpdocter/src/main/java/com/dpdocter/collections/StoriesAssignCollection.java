...
@Document(collection = "stories_assign_cl")
public class StoriesAssignCollection extends GenericCollection {
	...
	public String toString() {
		return "StoriesAssignCollection [id=" + id + ", schoolId=" + schoolId + ", branchId=" + branchId + ", storiesId="
				+ storiesId + ", fromDate=" + fromDate + ", toDate=" + toDate + ", standard=" + standard
