...
@Document(collection = "present_complaint_cl")
public class PresentComplaintCollection extends GenericCollection {
	...
	public String toString() {
		return "PresentComplaintCollection [id=" + id + ", presentComplaint=" + presentComplaint + ", doctorId="
