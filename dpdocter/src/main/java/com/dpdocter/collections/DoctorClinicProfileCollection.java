...
//	}
	...
	public String toString() {
		return "DoctorClinicProfileCollection [id=" + id + ", userLocationId=" + userLocationId + ", doctorId="
				...
				+ ", discarded=" + discarded + ", patientInitial=" + patientInitial + ", patientCounter="
				...
				+ ", facility=" + facility + ", noOfReviews=" + noOfReviews + ", noOfRecommenations="
				...
				+ ", labType=" + labType + ", iskiosk=" + iskiosk + ", isNutritionist=" + isNutritionist
				+ ", isSuperAdmin=" + isSuperAdmin + ", mrCode=" + mrCode + ", divisionIds=" + divisionIds + ", cityId="
				+ cityId + ", isVaccinationModuleOn=" + isVaccinationModuleOn + ", feedbackURL=" + feedbackURL
				+ ", isBulkSMSOn=" + isBulkSMSOn + "]";
	}
